...
},e.DisplacementFilter.prototype=Object.create(e.AbstractFilter.prototype),e.DisplacementFilter.prototype.constructor=e.DisplacementFilter,e.DisplacementFilter.prototype.onTextureLoaded=function(){this.uniforms.mapDimensions.value.x=this.uniforms.displacementMap.value.width,this.uniforms.mapDimensions.value.y=this.uniforms.displacementMap.value.height,this.uniforms.displacementMap.value.baseTexture.off("loaded",this.boundLoadedFunction)},Object.defineProperty(e.DisplacementFilter.prototype,"map",{get:function(){return this.uniforms.displacementMap.value},set:function(a){this.uniforms.displacementMap.value=a}}),Object.defineProperty(e.DisplacementFilter.prototype,"scale",{get:function(){return this.uniforms.scale.value},set:function(a){this.uniforms.scale.value=a}}),Object.defineProperty(e.DisplacementFilter.prototype,"offset",{get:function(){return this.uniforms.offset.value},set:function(a){this.uniforms.offset.value=a}}),e.PixelateFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={invert:{type:"1f",value:0},dimensions:{type:"4fv",value:new Float32Array([1e4,100,10,10])},pixelSize:{type:"2f",value:{x:10,y:10}}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform vec2 testDim;","uniform vec4 dimensions;","uniform vec2 pixelSize;","uniform sampler2D uSampler;","void main(void) {","   vec2 coord = vTextureCoord;","   vec2 size = dimensions.xy/pixelSize;","   vec2 color = floor( ( vTextureCoord * size ) ) / size + pixelSize/dimensions.xy * 0.5;","   gl_FragColor = texture2D(uSampler, color);","}"]},e.PixelateFilter.prototype=Object.create(e.AbstractFilter.prototype),e.PixelateFilter.prototype.constructor=e.PixelateFilter,Object.defineProperty(e.PixelateFilter.prototype,"size",{get:function(){return this.uniforms.pixelSize.value},set:function(a){this.dirty=!0,this.uniforms.pixelSize.value=a}}),e.BlurXFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={blur:{type:"1f",value:1/512}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform float blur;","uniform sampler2D uSampler;","void main(void) {","   vec4 sum = vec4(0.0);","   sum += texture2D(uSampler, vec2(vTextureCoord.x - 4.0*blur, vTextureCoord.y)) * 0.05;","   sum += texture2D(uSampler, vec2(vTextureCoord.x - 3.0*blur, vTextureCoord.y)) * 0.09;","   sum += texture2D(uSampler, vec2(vTextureCoord.x - 2.0*blur, vTextureCoord.y)) * 0.12;","   sum += texture2D(uSampler, vec2(vTextureCoord.x - blur, vTextureCoord.y)) * 0.15;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y)) * 0.16;","   sum += texture2D(uSampler, vec2(vTextureCoord.x + blur, vTextureCoord.y)) * 0.15;","   sum += texture2D(uSampler, vec2(vTextureCoord.x + 2.0*blur, vTextureCoord.y)) * 0.12;","   sum += texture2D(uSampler, vec2(vTextureCoord.x + 3.0*blur, vTextureCoord.y)) * 0.09;","   sum += texture2D(uSampler, vec2(vTextureCoord.x + 4.0*blur, vTextureCoord.y)) * 0.05;","   gl_FragColor = sum;","}"]},e.BlurXFilter.prototype=Object.create(e.AbstractFilter.prototype),e.BlurXFilter.prototype.constructor=e.BlurXFilter,Object.defineProperty(e.BlurXFilter.prototype,"blur",{get:function(){return this.uniforms.blur.value/(1/7e3)},set:function(a){this.dirty=!0,this.uniforms.blur.value=1/7e3*a}}),e.BlurYFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={blur:{type:"1f",value:1/512}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform float blur;","uniform sampler2D uSampler;","void main(void) {","   vec4 sum = vec4(0.0);","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y - 4.0*blur)) * 0.05;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y - 3.0*blur)) * 0.09;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y - 2.0*blur)) * 0.12;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y - blur)) * 0.15;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y)) * 0.16;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y + blur)) * 0.15;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y + 2.0*blur)) * 0.12;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y + 3.0*blur)) * 0.09;","   sum += texture2D(uSampler, vec2(vTextureCoord.x, vTextureCoord.y + 4.0*blur)) * 0.05;","   gl_FragColor = sum;","}"]},e.BlurYFilter.prototype=Object.create(e.AbstractFilter.prototype),e.BlurYFilter.prototype.constructor=e.BlurYFilter,Object.defineProperty(e.BlurYFilter.prototype,"blur",{get:function(){return this.uniforms.blur.value/(1/7e3)},set:function(a){this.uniforms.blur.value=1/7e3*a}}),e.BlurFilter=function(){this.blurXFilter=new e.BlurXFilter,this.blurYFilter=new e.BlurYFilter,this.passes=[this.blurXFilter,this.blurYFilter]},Object.defineProperty(e.BlurFilter.prototype,"blur",{get:function(){return this.blurXFilter.blur},set:function(a){this.blurXFilter.blur=this.blurYFilter.blur=a}}),Object.defineProperty(e.BlurFilter.prototype,"blurX",{get:function(){return this.blurXFilter.blur},set:function(a){this.blurXFilter.blur=a}}),Object.defineProperty(e.BlurFilter.prototype,"blurY",{get:function(){return this.blurYFilter.blur},set:function(a){this.blurYFilter.blur=a}}),e.InvertFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={invert:{type:"1f",value:1}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform float invert;","uniform sampler2D uSampler;","void main(void) {","   gl_FragColor = texture2D(uSampler, vTextureCoord);","   gl_FragColor.rgb = mix( (vec3(1)-gl_FragColor.rgb) * gl_FragColor.a, gl_FragColor.rgb, 1.0 - invert);","}"]},e.InvertFilter.prototype=Object.create(e.AbstractFilter.prototype),e.InvertFilter.prototype.constructor=e.InvertFilter,Object.defineProperty(e.InvertFilter.prototype,"invert",{get:function(){return this.uniforms.invert.value},set:function(a){this.uniforms.invert.value=a}}),e.SepiaFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={sepia:{type:"1f",value:1}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform float sepia;","uniform sampler2D uSampler;","const mat3 sepiaMatrix = mat3(0.3588, 0.7044, 0.1368, 0.2990, 0.5870, 0.1140, 0.2392, 0.4696, 0.0912);","void main(void) {","   gl_FragColor = texture2D(uSampler, vTextureCoord);","   gl_FragColor.rgb = mix( gl_FragColor.rgb, gl_FragColor.rgb * sepiaMatrix, sepia);","}"]},e.SepiaFilter.prototype=Object.create(e.AbstractFilter.prototype),e.SepiaFilter.prototype.constructor=e.SepiaFilter,Object.defineProperty(e.SepiaFilter.prototype,"sepia",{get:function(){return this.uniforms.sepia.value},set:function(a){this.uniforms.sepia.value=a}}),e.TwistFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={radius:{type:"1f",value:.5},angle:{type:"1f",value:5},offset:{type:"2f",value:{x:.5,y:.5}}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform vec4 dimensions;","uniform sampler2D uSampler;","uniform float radius;","uniform float angle;","uniform vec2 offset;","void main(void) {","   vec2 coord = vTextureCoord - offset;","   float distance = length(coord);","   if (distance < radius) {","       float ratio = (radius - distance) / radius;","       float angleMod = ratio * ratio * angle;","       float s = sin(angleMod);","       float c = cos(angleMod);","       coord = vec2(coord.x * c - coord.y * s, coord.x * s + coord.y * c);","   }","   gl_FragColor = texture2D(uSampler, coord+offset);","}"]},e.TwistFilter.prototype=Object.create(e.AbstractFilter.prototype),e.TwistFilter.prototype.constructor=e.TwistFilter,Object.defineProperty(e.TwistFilter.prototype,"offset",{get:function(){return this.uniforms.offset.value},set:function(a){this.dirty=!0,this.uniforms.offset.value=a}}),Object.defineProperty(e.TwistFilter.prototype,"radius",{get:function(){return this.uniforms.radius.value},set:function(a){this.dirty=!0,this.uniforms.radius.value=a}}),Object.defineProperty(e.TwistFilter.prototype,"angle",{get:function(){return this.uniforms.angle.value},set:function(a){this.dirty=!0,this.uniforms.angle.value=a}}),e.ColorStepFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={step:{type:"1f",value:5}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform sampler2D uSampler;","uniform float step;","void main(void) {","   vec4 color = texture2D(uSampler, vTextureCoord);","   color = floor(color * step) / step;","   gl_FragColor = color;","}"]},e.ColorStepFilter.prototype=Object.create(e.AbstractFilter.prototype),e.ColorStepFilter.prototype.constructor=e.ColorStepFilter,Object.defineProperty(e.ColorStepFilter.prototype,"step",{get:function(){return this.uniforms.step.value},set:function(a){this.uniforms.step.value=a}}),e.DotScreenFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={scale:{type:"1f",value:1},angle:{type:"1f",value:5},dimensions:{type:"4fv",value:[0,0,0,0]}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform vec4 dimensions;","uniform sampler2D uSampler;","uniform float angle;","uniform float scale;","float pattern() {","   float s = sin(angle), c = cos(angle);","   vec2 tex = vTextureCoord * dimensions.xy;","   vec2 point = vec2(","       c * tex.x - s * tex.y,","       s * tex.x + c * tex.y","   ) * scale;","   return (sin(point.x) * sin(point.y)) * 4.0;","}","void main() {","   vec4 color = texture2D(uSampler, vTextureCoord);","   float average = (color.r + color.g + color.b) / 3.0;","   gl_FragColor = vec4(vec3(average * 10.0 - 5.0 + pattern()), color.a);","}"]},e.DotScreenFilter.prototype=Object.create(e.DotScreenFilter.prototype),e.DotScreenFilter.prototype.constructor=e.DotScreenFilter,Object.defineProperty(e.DotScreenFilter.prototype,"scale",{get:function(){return this.uniforms.scale.value},set:function(a){this.dirty=!0,this.uniforms.scale.value=a}}),Object.defineProperty(e.DotScreenFilter.prototype,"angle",{get:function(){return this.uniforms.angle.value},set:function(a){this.dirty=!0,this.uniforms.angle.value=a}}),e.CrossHatchFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={blur:{type:"1f",value:1/512}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform float blur;","uniform sampler2D uSampler;","void main(void) {","    float lum = length(texture2D(uSampler, vTextureCoord.xy).rgb);","    gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);","    if (lum < 1.00) {","        if (mod(gl_FragCoord.x + gl_FragCoord.y, 10.0) == 0.0) {","            gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);","        }","    }","    if (lum < 0.75) {","        if (mod(gl_FragCoord.x - gl_FragCoord.y, 10.0) == 0.0) {","            gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);","        }","    }","    if (lum < 0.50) {","        if (mod(gl_FragCoord.x + gl_FragCoord.y - 5.0, 10.0) == 0.0) {","            gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);","        }","    }","    if (lum < 0.3) {","        if (mod(gl_FragCoord.x - gl_FragCoord.y - 5.0, 10.0) == 0.0) {","            gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0);","        }","    }","}"]},e.CrossHatchFilter.prototype=Object.create(e.AbstractFilter.prototype),e.CrossHatchFilter.prototype.constructor=e.BlurYFilter,Object.defineProperty(e.CrossHatchFilter.prototype,"blur",{get:function(){return this.uniforms.blur.value/(1/7e3)},set:function(a){this.uniforms.blur.value=1/7e3*a}}),e.RGBSplitFilter=function(){e.AbstractFilter.call(this),this.passes=[this],this.uniforms={red:{type:"2f",value:{x:20,y:20}},green:{type:"2f",value:{x:-20,y:20}},blue:{type:"2f",value:{x:20,y:-20}},dimensions:{type:"4fv",value:[0,0,0,0]}},this.fragmentSrc=["precision mediump float;","varying vec2 vTextureCoord;","varying vec4 vColor;","uniform vec2 red;","uniform vec2 green;","uniform vec2 blue;","uniform vec4 dimensions;","uniform sampler2D uSampler;","void main(void) {","   gl_FragColor.r = texture2D(uSampler, vTextureCoord + red/dimensions.xy).r;","   gl_FragColor.g = texture2D(uSampler, vTextureCoord + green/dimensions.xy).g;","   gl_FragColor.b = texture2D(uSampler, vTextureCoord + blue/dimensions.xy).b;","   gl_FragColor.a = texture2D(uSampler, vTextureCoord).a;","}"]},e.RGBSplitFilter.prototype=Object.create(e.AbstractFilter.prototype),e.RGBSplitFilter.prototype.constructor=e.RGBSplitFilter,Object.defineProperty(e.RGBSplitFilter.prototype,"angle",{get:function(){return this.uniforms.blur.value/(1/7e3)},set:function(a){this.uniforms.blur.value=1/7e3*a}}),"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=e),exports.PIXI=e):"undefined"!=typeof define&&define.amd?define(e):d.PIXI=e}).call(this),function(a,b,c){"undefined"!=typeof module&&module.exports?module.exports=c():"function"==typeof b.define&&b.define.amd?define(a,[],c):b[a]=c()}("buzz",this,function(){var a={defaults:{autoplay:!1,duration:5e3,formats:[],loop:!1,placeholder:"--",preload:"metadata",volume:80,document:document},types:{mp3:"audio/mpeg",ogg:"audio/ogg",wav:"audio/wav",aac:"audio/aac",m4a:"audio/x-m4a"},sounds:[],el:document.createElement("audio"),sound:function(b,c){function d(a){for(var b=[],c=a.length-1,d=0;c>=d;d++)b.push({start:a.start(d),end:a.end(d)});return b}function e(a){return a.split(".").pop()}function f(b,c){var d=g.createElement("source");d.src=c,a.types[e(c)]&&(d.type=a.types[e(c)]),b.appendChild(d)}c=c||{};var g=c.document||a.defaults.document,h=0,i=[],j={},k=a.isSupported();if(this.load=function(){return k?(this.sound.load(),this):this},this.play=function(){return k?(this.sound.play(),this):this},this.togglePlay=function(){return k?(this.sound.paused?this.sound.play():this.sound.pause(),this):this},this.pause=function(){return k?(this.sound.pause(),this):this},this.isPaused=function(){return k?this.sound.paused:null},this.stop=function(){return k?(this.setTime(0),this.sound.pause(),this):this},this.isEnded=function(){return k?this.sound.ended:null},this.loop=function(){return k?(this.sound.loop="loop",this.bind("ended.buzzloop",function(){this.currentTime=0,this.play()}),this):this},this.unloop=function(){return k?(this.sound.removeAttribute("loop"),this.unbind("ended.buzzloop"),this):this},this.mute=function(){return k?(this.sound.muted=!0,this):this},this.unmute=function(){return k?(this.sound.muted=!1,this):this},this.toggleMute=function(){return k?(this.sound.muted=!this.sound.muted,this):this},this.isMuted=function(){return k?this.sound.muted:null},this.setVolume=function(a){return k?(0>a&&(a=0),a>100&&(a=100),this.volume=a,this.sound.volume=a/100,this):this},this.getVolume=function(){return k?this.volume:this},this.increaseVolume=function(a){return this.setVolume(this.volume+(a||1))},this.decreaseVolume=function(a){return this.setVolume(this.volume-(a||1))},this.setTime=function(a){if(!k)return this;var b=!0;return this.whenReady(function(){b===!0&&(b=!1,this.sound.currentTime=a)}),this},this.getTime=function(){if(!k)return null;var b=Math.round(100*this.sound.currentTime)/100;return isNaN(b)?a.defaults.placeholder:b},this.setPercent=function(b){return k?this.setTime(a.fromPercent(b,this.sound.duration)):this},this.getPercent=function(){if(!k)return null;var b=Math.round(a.toPercent(this.sound.currentTime,this.sound.duration));return isNaN(b)?a.defaults.placeholder:b},this.setSpeed=function(a){return k?(this.sound.playbackRate=a,this):this},this.getSpeed=function(){return k?this.sound.playbackRate:null},this.getDuration=function(){if(!k)return null;var b=Math.round(100*this.sound.duration)/100;return isNaN(b)?a.defaults.placeholder:b},this.getPlayed=function(){return k?d(this.sound.played):null},this.getBuffered=function(){return k?d(this.sound.buffered):null},this.getSeekable=function(){return k?d(this.sound.seekable):null},this.getErrorCode=function(){return k&&this.sound.error?this.sound.error.code:0},this.getErrorMessage=function(){if(!k)return null;switch(this.getErrorCode()){case 1:return"MEDIA_ERR_ABORTED";case 2:return"MEDIA_ERR_NETWORK";case 3:return"MEDIA_ERR_DECODE";case 4:return"MEDIA_ERR_SRC_NOT_SUPPORTED";default:return null}},this.getStateCode=function(){return k?this.sound.readyState:null},this.getStateMessage=function(){if(!k)return null;switch(this.getStateCode()){case 0:return"HAVE_NOTHING";case 1:return"HAVE_METADATA";case 2:return"HAVE_CURRENT_DATA";case 3:return"HAVE_FUTURE_DATA";case 4:return"HAVE_ENOUGH_DATA";default:return null}},this.getNetworkStateCode=function(){return k?this.sound.networkState:null},this.getNetworkStateMessage=function(){if(!k)return null;switch(this.getNetworkStateCode()){case 0:return"NETWORK_EMPTY";case 1:return"NETWORK_IDLE";case 2:return"NETWORK_LOADING";case 3:return"NETWORK_NO_SOURCE";default:return null}},this.set=function(a,b){return k?(this.sound[a]=b,this):this},this.get=function(a){return k?a?this.sound[a]:this.sound:null},this.bind=function(a,b){if(!k)return this;a=a.split(" ");for(var c=this,d=function(a){b.call(c,a)},e=0;e<a.length;e++){var f=a[e],g=f;f=g.split(".")[0],i.push({idx:g,func:d}),this.sound.addEventListener(f,d,!0)}return this},this.unbind=function(a){if(!k)return this;a=a.split(" ");for(var b=0;b<a.length;b++)for(var c=a[b],d=c.split(".")[0],e=0;e<i.length;e++){var f=i[e].idx.split(".");(i[e].idx==c||f[1]&&f[1]==c.replace(".",""))&&(this.sound.removeEventListener(d,i[e].func,!0),i.splice(e,1))}return this},this.bindOnce=function(a,b){if(!k)return this;var c=this;return j[h++]=!1,this.bind(a+"."+h,function(){j[h]||(j[h]=!0,b.call(c)),c.unbind(a+"."+h)}),this},this.trigger=function(a){if(!k)return this;a=a.split(" ");for(var b=0;b<a.length;b++)for(var c=a[b],d=0;d<i.length;d++){var e=i[d].idx.split(".");if(i[d].idx==c||e[0]&&e[0]==c.replace(".","")){var f=g.createEvent("HTMLEvents");f.initEvent(e[0],!1,!0),this.sound.dispatchEvent(f)}}return this},this.fadeTo=function(b,c,d){function e(){setTimeout(function(){b>f&&h.volume<b?(h.setVolume(h.volume+=1),e()):f>b&&h.volume>b?(h.setVolume(h.volume-=1),e()):d instanceof Function&&d.apply(h)},g)}if(!k)return this;c instanceof Function?(d=c,c=a.defaults.duration):c=c||a.defaults.duration;var f=this.volume,g=c/Math.abs(f-b),h=this;return this.play(),this.whenReady(function(){e()}),this},this.fadeIn=function(a,b){return k?this.setVolume(0).fadeTo(100,a,b):this},this.fadeOut=function(a,b){return k?this.fadeTo(0,a,b):this},this.fadeWith=function(a,b){return k?(this.fadeOut(b,function(){this.stop()}),a.play().fadeIn(b),this):this},this.whenReady=function(a){if(!k)return null;var b=this;0===this.sound.readyState?this.bind("canplay.buzzwhenready",function(){a.call(b)}):a.call(b)},k&&b){for(var l in a.defaults)a.defaults.hasOwnProperty(l)&&(c[l]=c[l]||a.defaults[l]);if(this.sound=g.createElement("audio"),b instanceof Array)for(var m in b)b.hasOwnProperty(m)&&f(this.sound,b[m]);else if(c.formats.length)for(var n in c.formats)c.formats.hasOwnProperty(n)&&f(this.sound,b+"."+c.formats[n]);else f(this.sound,b);c.loop&&this.loop(),c.autoplay&&(this.sound.autoplay="autoplay"),this.sound.preload=c.preload===!0?"auto":c.preload===!1?"none":c.preload,this.setVolume(c.volume),a.sounds.push(this)}},group:function(a){function b(){for(var b=c(null,arguments),d=b.shift(),e=0;e<a.length;e++)a[e][d].apply(a[e],b)}function c(a,b){return a instanceof Array?a:Array.prototype.slice.call(b)}a=c(a,arguments),this.getSounds=function(){return a},this.add=function(b){b=c(b,arguments);for(var d=0;d<b.length;d++)a.push(b[d])},this.remove=function(b){b=c(b,arguments);for(var d=0;d<b.length;d++)for(var e=0;e<a.length;e++)if(a[e]==b[d]){a.splice(e,1);break}},this.load=function(){return b("load"),this},this.play=function(){return b("play"),this},this.togglePlay=function(){return b("togglePlay"),this},this.pause=function(a){return b("pause",a),this},this.stop=function(){return b("stop"),this},this.mute=function(){return b("mute"),this},this.unmute=function(){return b("unmute"),this},this.toggleMute=function(){return b("toggleMute"),this},this.setVolume=function(a){return b("setVolume",a),this},this.increaseVolume=function(a){return b("increaseVolume",a),this},this.decreaseVolume=function(a){return b("decreaseVolume",a),this},this.loop=function(){return b("loop"),this},this.unloop=function(){return b("unloop"),this},this.setTime=function(a){return b("setTime",a),this},this.set=function(a,c){return b("set",a,c),this},this.bind=function(a,c){return b("bind",a,c),this},this.unbind=function(a){return b("unbind",a),this},this.bindOnce=function(a,c){return b("bindOnce",a,c),this},this.trigger=function(a){return b("trigger",a),this},this.fade=function(a,c,d,e){return b("fade",a,c,d,e),this},this.fadeIn=function(a,c){return b("fadeIn",a,c),this},this.fadeOut=function(a,c){return b("fadeOut",a,c),this}},all:function(){return new a.group(a.sounds)},isSupported:function(){return!!a.el.canPlayType},isOGGSupported:function(){return!!a.el.canPlayType&&a.el.canPlayType('audio/ogg; codecs="vorbis"')},isWAVSupported:function(){return!!a.el.canPlayType&&a.el.canPlayType('audio/wav; codecs="1"')},isMP3Supported:function(){return!!a.el.canPlayType&&a.el.canPlayType("audio/mpeg;")},isAACSupported:function(){return!!a.el.canPlayType&&(a.el.canPlayType("audio/x-m4a;")||a.el.canPlayType("audio/aac;"))},toTimer:function(a,b){var c,d,e;return c=Math.floor(a/3600),c=isNaN(c)?"--":c>=10?c:"0"+c,d=b?Math.floor(a/60%60):Math.floor(a/60),d=isNaN(d)?"--":d>=10?d:"0"+d,e=Math.floor(a%60),e=isNaN(e)?"--":e>=10?e:"0"+e,b?c+":"+d+":"+e:d+":"+e},fromTimer:function(a){var b=a.toString().split(":");return b&&3==b.length&&(a=3600*parseInt(b[0],10)+60*parseInt(b[1],10)+parseInt(b[2],10)),b&&2==b.length&&(a=60*parseInt(b[0],10)+parseInt(b[1],10)),a},toPercent:function(a,b,c){var d=Math.pow(10,c||0);return Math.round(100*a/b*d)/d},fromPercent:function(a,b,c){var d=Math.pow(10,c||0);return Math.round(b/100*a*d)/d}};return a}),CANDY.BulletsManager=function(a){PIXI.DisplayObjectContainer.call(this);var b=20;this.bullets=[];for(var c=[];b--;){var d=new CANDY.Bullet;this.addChild(d),this.bullets.push(d),c.push(d)}this.pool=new CANDY.Pool(c),this.SHOOT_DELAY=15,this.shootTimer=0,this.player=a},CANDY.BulletsManager.constructor=CANDY.BulletsManager,CANDY.BulletsManager.prototype=Object.create(PIXI.DisplayObjectContainer.prototype),CANDY.BulletsManager.prototype.updateTransform=function(){this.shootTimer--,this.player.canShoot&&this.shootTimer<=0&&CANDY.Controls.pressed(CANDY.Controls.S)&&this.shoot(),PIXI.DisplayObjectContainer.prototype.updateTransform.call(this)},CANDY.BulletsManager.prototype.shoot=function(){var a=this;this.pool.act(function(b){b.alloc(),b.position.x=a.player.position.x+a.player.width-b.speedX-5,b.position.y=a.player.position.y+a.player.height/2+35,a.player.speedX-=2,a.player.speedY*=.3}),this.shootTimer=this.SHOOT_DELAY},CANDY.Bullet=function(){PIXI.Sprite.call(this,PIXI.Texture.fromImage("img/bullet.png")),this.visible=!1,this.damage=1},CANDY.Bullet.constructor=CANDY.Bullet,CANDY.Bullet.prototype=Object.create(PIXI.Sprite.prototype),CANDY.Bullet.prototype.alloc=function(){this.speedX=CANDY.Utils.randomBetween(10,12),this.speedY=CANDY.Utils.randomBetween(-.5,.5),this.visible=!0},CANDY.Bullet.prototype.canRealloc=function(){this.visible=!1,this.parent.pool.add(this)},CANDY.Bullet.prototype.updateTransform=function(){this.visible&&(this.position.x+=this.speedX,this.position.y+=this.speedY,this.position.x>CANDY.Config.width&&this.canRealloc()),PIXI.Sprite.prototype.updateTransform.call(this)},CANDY.Enemy=function(a){PIXI.MovieClip.call(this,a),this.anchor.x=this.anchor.y=.5,this.visible=!1,this.active=!1,this.hitOffset||(this.hitOffset={x:0,y:0})},CANDY.Enemy.constructor=CANDY.Enemy,CANDY.Enemy.prototype=Object.create(PIXI.MovieClip.prototype),CANDY.Enemy.prototype.alloc=function(){this.alpha=1,this.visible=!0,this.active=!0,this.dying=!1,this.scale.x=this.scale.y=1,this.rotation=0},CANDY.Enemy.prototype.canRealloc=function(){this.visible=!1,this.active=!1,this.poolName&&CANDY.enemiesManager[this.poolName+"Pool"].add(this)},CANDY.Enemy.prototype.updateTransform=function(){this.hitArea&&(this.hitArea.x=this.position.x+this.hitOffset.x-this.width/2,this.hitArea.y=this.position.y+this.hitOffset.y-this.height/2),this.dying&&(this.alpha-=.1,this.speedX*=.5,this.speedY*=.5,this.scale.x-=.08,this.scale.y-=.08,this.rotation+=.1,this.alpha<=0&&this.die()),this.position.x+=this.speedX,this.position.y+=this.speedY,PIXI.MovieClip.prototype.updateTransform.call(this)},CANDY.Enemy.prototype.touched=function(a){this.life=this.life-a.damage,this.life<=0&&(this.active=!1,this.dying=!0)},CANDY.Enemy.prototype.die=function(){this.dying=!1,this.canRealloc()},CANDY.PapaSmurf=function(){var a=CANDY.SpriteSheetTextures.getArray("papasmurf",".png",4);CANDY.Enemy.call(this,a),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,150,250),this.animationSpeed=.1,this.hitOffset={x:90,y:90}},CANDY.PapaSmurf.constructor=CANDY.PapaSmurf,CANDY.PapaSmurf.prototype=Object.create(CANDY.Enemy.prototype),CANDY.PapaSmurf.prototype.alloc=function(){this.stop(),CANDY.Enemy.prototype.alloc.call(this),this.life=100,this.position.x=CANDY.Config.width+this.width/2,this.position.y=CANDY.Config.height/2,this.speedX=-10.5,this.speedY=0,this.newGoal(),this.canMove=!1,CANDY.BossUI.majBar(100)},CANDY.PapaSmurf.prototype.updateTransform=function(){this.speedX<-.1?this.speedX*=.96:this.speedX=0,Math.abs(this.goal-this.position.y)<10&&this.newGoal(),this.canMove?(this.play(),this.speedY+=this.goal<this.position.y?-.1:.1,this.speedY=CANDY.Utils.boundary(this.speedY,-2,2)):this.speedY=0,CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.PapaSmurf.prototype.touched=function(a){CANDY.Enemy.prototype.touched.call(this,a),CANDY.BossUI.majBar(this.life)},CANDY.PapaSmurf.prototype.newGoal=function(){this.goal=CANDY.Utils.randomBetween(this.height/2,CANDY.Config.height-this.height/2)},CANDY.Smurf=function(){var a=CANDY.SpriteSheetTextures.getArray("smurf",".png",4);CANDY.Enemy.call(this,a),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,60,100),this.hitOffset={x:25,y:30},this.animationSpeed=.1,this.poolName="smurf"},CANDY.Smurf.constructor=CANDY.Smurf,CANDY.Smurf.prototype=Object.create(CANDY.Enemy.prototype),CANDY.Smurf.prototype.alloc=function(){this.life=2,this.position.x=CANDY.Config.width+100+CANDY.Utils.randomBetween(0,200),this.speedX=CANDY.Utils.randomBetween(-3,-5),this.speedY=0,this.gotoAndPlay(CANDY.Utils.randomBetween(1,4)),CANDY.Enemy.prototype.alloc.call(this)},CANDY.Smurf.prototype.updateTransform=function(){this.active&&this.position.x<-50&&this.canRealloc(),CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.Magic=function(){var a=CANDY.SpriteSheetTextures.getArray("bolt",".png",2);CANDY.Enemy.call(this,a),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,30,this.height),this.animationSpeed=.2,this.poolName="magic",this.cantTouch=!0},CANDY.Magic.constructor=CANDY.Magic,CANDY.Magic.prototype=Object.create(CANDY.Enemy.prototype),CANDY.Magic.prototype.alloc=function(){this.life=100,this.position.x=this.parent.papaSmurf.position.x-90,this.position.y=this.parent.papaSmurf.position.y-100,this.speedX=CANDY.Utils.randomBetween(-4,-8),this.speedY=CANDY.Utils.randomBetween(-2.5,2.5),this.play(),CANDY.Enemy.prototype.alloc.call(this)},CANDY.Magic.prototype.updateTransform=function(){this.active&&this.position.x<-50&&this.canRealloc(),CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.Apple=function(){CANDY.Enemy.call(this,[PIXI.Texture.fromImage("img/apple.png")]),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,220,210),this.animationSpeed=.2,this.hitOffset={x:40,y:80}},CANDY.Apple.constructor=CANDY.Apple,CANDY.Apple.prototype=Object.create(CANDY.Enemy.prototype),CANDY.Apple.prototype.alloc=function(){CANDY.Enemy.prototype.alloc.call(this),this.life=125,this.position.x=CANDY.Config.width+this.width/2,this.position.y=CANDY.Config.height/2,this.speedX=-10,this.speedY=0,this.accel=!1,this.decel=!1,this.jumpComplete=!1,CANDY.BossUI.majBar(100)},CANDY.Apple.prototype.updateTransform=function(){this.speedX<-.1?this.speedX*=.96:this.speedX=0,this.accel?(this.speedY+=.4*this.direction,Math.abs(this.speedY)>=10&&(this.accel=!1,this.decel=!0)):this.decel&&(this.speedY-=.5*this.direction,Math.abs(this.speedY)<.5&&(this.speedY=0,this.decel=!1,this.active&&(this.jumpComplete=!0))),this.scale.x=this.scale.y=1+Math.abs(this.speedY)/40,CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.Apple.prototype.touched=function(a){CANDY.Enemy.prototype.touched.call(this,a),CANDY.BossUI.majBar(this.life/125*100)},CANDY.Apple.prototype.jump=function(){CANDY.Sounds.play("jump"),this.direction=Math.random()<.5?-1:1,this.position.y<200?this.direction=1:this.position.y>600&&(this.direction=-1),this.accel=!0},CANDY.Skittle=function(){CANDY.Enemy.call(this,[PIXI.Texture.fromImage("img/skittle"+CANDY.Utils.randomBetween(1,4)+".png")]),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,53,53),this.animationSpeed=.2,this.poolName="skittle",this.hitOffset={x:9,y:0}},CANDY.Skittle.constructor=CANDY.Skittle,CANDY.Skittle.prototype=Object.create(CANDY.Enemy.prototype),CANDY.Skittle.prototype.alloc=function(){this.position.x=this.parent.apple.position.x,this.position.y=this.parent.apple.position.y,this.life=1,this.speedX=CANDY.Utils.randomBetween(2,5),Math.random()<.5&&(this.speedX*=-1),this.speedY=CANDY.Utils.randomBetween(2,5),Math.random()<.5&&(this.speedY*=-1),CANDY.Enemy.prototype.alloc.call(this),this.randomRotateSpeed(),this.rotation=CANDY.Utils.randomBetween(0,6)},CANDY.Skittle.prototype.updateTransform=function(){this.active&&((this.position.x<this.width/2||this.position.x>CANDY.Config.width-this.width/2)&&(this.speedX*=-1,this.randomRotateSpeed()),(this.position.y<this.height/2||this.position.y>CANDY.Config.height-this.height/2)&&(this.speedY*=-1,this.randomRotateSpeed()),this.rotation+=this.rotateSpeed),CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.Skittle.prototype.randomRotateSpeed=function(){this.rotateSpeed=CANDY.Utils.randomBetween(.01,.03,!0),Math.random()<.5&&(this.rotateSpeed*=-1)},CANDY.King=function(){CANDY.Enemy.call(this,[PIXI.Texture.fromImage("img/king.png")]),this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,250,520),this.hitOffset={x:160,y:0},this.animationSpeed=.2},CANDY.King.constructor=CANDY.King,CANDY.King.prototype=Object.create(CANDY.Enemy.prototype),CANDY.King.prototype.alloc=function(){CANDY.Enemy.prototype.alloc.call(this),this.life=150,this.position.x=CANDY.Config.width+this.width/2,this.position.y=CANDY.Config.height/2,this.speedX=-18,this.speedY=0,CANDY.BossUI.majBar(100)},CANDY.King.prototype.updateTransform=function(){this.speedX<-.1?this.speedX*=.96:this.speedX=0,CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.King.prototype.touched=function(a){CANDY.Enemy.prototype.touched.call(this,a),CANDY.BossUI.majBar(this.life/150*100)},CANDY.CandyShadow=function(){CANDY.Enemy.call(this,[PIXI.Texture.fromImage("img/candy-shadow.png")]),this.animationSpeed=.2,this.poolName="candyShadow"},CANDY.CandyShadow.constructor=CANDY.CandyShadow,CANDY.CandyShadow.prototype=Object.create(CANDY.Enemy.prototype),CANDY.CandyShadow.prototype.alloc=function(a){Math.random()>.7?(this.position.x=CANDY.Utils.randomBetween(a.x-150,a.x+150)+90,this.position.y=CANDY.Utils.randomBetween(a.y-100,a.y+100)+140,this.position.x=CANDY.Utils.boundary(this.position.x,this.width/2,.6*CANDY.Config.width),this.position.y=CANDY.Utils.boundary(this.position.y,this.height/2+50,CANDY.Config.height-this.height)):(this.position.x=CANDY.Utils.randomBetween(this.width/2,.6*CANDY.Config.width),this.position.y=CANDY.Utils.randomBetween(this.height/2+50,CANDY.Config.height-this.height)),this.life=1,this.speedX=0,this.speedY=0,CANDY.Enemy.prototype.alloc.call(this),this.alpha=.01,this.scale.x=this.scale.y=.01,this.coming=!0
},CANDY.CandyShadow.prototype.updateTransform=function(){this.active&&(this.coming?(this.alpha+=.008,this.scale.x=this.scale.y=this.alpha,this.alpha>=1&&(this.alpha=1,this.coming=!1)):(this.alpha-=.05,this.alpha<=0&&(this.alpha=0,this.canRealloc()))),CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.Candy=function(){CANDY.Enemy.call(this,[PIXI.Texture.fromImage("img/candy"+CANDY.Utils.randomBetween(1,6)+".png")]),this.animationSpeed=.2,this.poolName="candy",this.hitOffset={x:0,y:140}},CANDY.Candy.constructor=CANDY.Candy,CANDY.Candy.prototype=Object.create(CANDY.Enemy.prototype),CANDY.Candy.prototype.alloc=function(a){this.position.x=a.position.x,this.position.y=a.position.y-900,this.life=1,this.speedX=0,this.speedY=0,this.fallen=!1,CANDY.Enemy.prototype.alloc.call(this),this.waitTime=40,this.hitArea=!1},CANDY.Candy.prototype.updateTransform=function(){this.active&&(this.waitTime--,this.waitTime<=-89?(this.speedY=0,this.alpha-=.05,this.alpha<.2?this.fallen||(this.fallen=!0,this.hitArea=new CANDY.Rectangle(this.position.x,this.position.y,210,70),CANDY.Sounds.play("candyfall")):this.hitArea=!1,this.alpha<=0&&(this.alpha=0,this.canRealloc())):this.waitTime<=0&&(this.speedY+=.2)),CANDY.Enemy.prototype.updateTransform.call(this)},CANDY.EnemiesManager=function(a,b){PIXI.DisplayObjectContainer.call(this),this.player=a,this.callbackEnd=b,this.enemies=[],this.currentLevel=!1},CANDY.EnemiesManager.constructor=CANDY.EnemiesManager,CANDY.EnemiesManager.prototype=Object.create(PIXI.DisplayObjectContainer.prototype),CANDY.EnemiesManager.prototype.init=function(){this.createPool("Magic","magic",30),this.createPool("Smurf","smurf",20),this.createPool("Skittle","skittle",30),this.createPool("CandyShadow","candyShadow",30),this.createPool("Candy","candy",30),this.papaSmurf=new CANDY.PapaSmurf,this.enemies.push(this.papaSmurf),this.apple=new CANDY.Apple,this.enemies.push(this.apple),this.king=new CANDY.King,this.enemies.push(this.king)},CANDY.EnemiesManager.prototype.createPool=function(a,b,c){var d=[];for(this[b]=[];c--;){var e=new CANDY[a];"Candy"==a?this.stage.addChild(e):this.addChild(e),this[b].push(e),d.push(e),this.enemies.push(e)}this[b+"Pool"]=new CANDY.Pool(d)},CANDY.EnemiesManager.prototype.updateTransform=function(){var a=this;switch(this.currentLevel){case 1:if(this.timerAttack<=0&&(this.papaSmurfAttack(),this.timerAttack=CANDY.Utils.randomBetween(90,180)),this.timerAppear<=0&&(this.smurfWave(),this.timerAppear=CANDY.Utils.randomBetween(240,300)),this.papaSmurf.dying){this.currentLevel=!1,CANDY.BossUI.hide();for(var b=0;b<this.smurf.length;b++)this.smurf[b].active&&this.smurf[b].touched({damage:100});this.player.canShoot=!1,setTimeout(function(){a.initLevel2()},5e3)}break;case 2:if(this.timerAttack<=0&&(this.apple.jump(),this.timerAttack=CANDY.Utils.randomBetween(150,250)),this.apple.jumpComplete&&(this.skittleWave(),this.apple.jumpComplete=!1),this.apple.dying){this.currentLevel=!1,CANDY.BossUI.hide();for(var b=0;b<this.skittle.length;b++)this.skittle[b].active&&this.skittle[b].touched({damage:100});this.player.canShoot=!1,setTimeout(function(){a.initLevel3()},5e3)}break;case 3:if(this.timerAttack<=0&&(this.candyDrop(),this.timerAttack=CANDY.Utils.randomBetween(10,30)),this.king.dying){this.currentLevel=!1,CANDY.BossUI.hide();for(var b=0;b<this.candyShadow.length;b++)this.candyShadow[b].active&&this.candyShadow[b].canRealloc();for(var b=0;b<this.candy.length;b++)this.candy[b].active&&this.candy[b].canRealloc();this.callbackEnd()}}this.timerAttack--,this.timerAppear--,PIXI.DisplayObjectContainer.prototype.updateTransform.call(this)},CANDY.EnemiesManager.prototype.initLevel1=function(){var a=this;a.player.canShoot=!1,this.addChild(this.papaSmurf),this.papaSmurf.alloc(),this.timerAttack=420,this.timerAppear=460,this.currentLevel=1,setTimeout(function(){CANDY.BossUI.setName("Papa Smurf"),CANDY.BossUI.show()},2e3),setTimeout(function(){CANDY.BossUI.showBubble("You shall not scroll !"),CANDY.Sounds.play("smurf")},3e3),setTimeout(function(){CANDY.BossUI.hideBubble(),a.papaSmurf.canMove=!0,a.player.canShoot=!0},6e3)},CANDY.EnemiesManager.prototype.papaSmurfAttack=function(){CANDY.Sounds.play("fire");for(var a=CANDY.Utils.randomBetween(2,3);a--;)this.magicPool.act(function(a){a.alloc()})},CANDY.EnemiesManager.prototype.smurfWave=function(){for(var a=this,b=CANDY.Utils.randomBetween(4,6),c=b,d=0;b--;)this.smurfPool.act(function(b){b.alloc();var e=CANDY.Utils.randomBetween(0,1,!0),f=(CANDY.Config.height-160)/c;b.position.y=f*d+f*e+80,a.addChild(b),d++});a.addChild(a.papaSmurf)},CANDY.EnemiesManager.prototype.initLevel2=function(){var a=this;a.player.canShoot=!1,this.addChild(this.apple),this.apple.alloc(),this.timerAttack=420,this.currentLevel=2,setTimeout(function(){CANDY.BossUI.setName("Big Chomped Apple"),CANDY.BossUI.show()},2e3),setTimeout(function(){CANDY.BossUI.showBubble("My revolutionnary Skittles 5S will destroy you !"),CANDY.Sounds.play("apple")},3e3),setTimeout(function(){CANDY.BossUI.hideBubble(),a.player.canShoot=!0},6e3)},CANDY.EnemiesManager.prototype.skittleWave=function(){for(var a=CANDY.Utils.randomBetween(3,5);a--;)this.skittlePool.act(function(a){a.alloc()})},CANDY.EnemiesManager.prototype.initLevel3=function(){var a=this;a.player.canShoot=!1,this.addChild(this.king),this.king.alloc(),this.timerAttack=420,this.currentLevel=3,setTimeout(function(){CANDY.BossUI.setName("The King"),CANDY.BossUI.show()},2e3),setTimeout(function(){CANDY.BossUI.showBubble("Candies ... Candies ... CANDIES everywhere !"),CANDY.Sounds.play("king")},3e3),setTimeout(function(){CANDY.BossUI.hideBubble(),a.player.canShoot=!0},6e3)},CANDY.EnemiesManager.prototype.candyDrop=function(){var a=this;this.candyShadowPool.act(function(b){b.alloc(a.player.position),a.candyPool.act(function(a){a.alloc(b)})})},CANDY.EnemiesManager.prototype.removeAll=function(){this.currentLevel=!1;for(var a=0;a<this.enemies.length;a++)this.enemies[a].active&&this.enemies[a].canRealloc()},CANDY.Player=function(){var a=CANDY.SpriteSheetTextures.getArray("player",".png",4);PIXI.MovieClip.call(this,a),this.ACCELERATION=.4,this.MAX_SPEED=6,this.MIN_X=0,this.MIN_Y=0,this.MAX_X=.6*(CANDY.Config.width-this.width),this.MAX_Y=CANDY.Config.height-this.height,this.animationSpeed=.1,this.hitArea=new CANDY.Rectangle(0,0,85,85),this.hitOffset={x:50,y:70}},CANDY.Player.constructor=CANDY.Player,CANDY.Player.prototype=Object.create(PIXI.MovieClip.prototype),CANDY.Player.prototype.init=function(){this.position.x=100,this.position.y=340,this.speedX=this.speedY=0,this.canShoot=!1,this.life=this.maxLife=10,this.hitTimer=0,this.visible=!0,CANDY.PlayerUI.majBar(100)},CANDY.Player.prototype.hitEnnemy=function(){this.hitTimer>0||(this.life--,CANDY.PlayerUI.majBar(this.life/this.maxLife*100),0===this.life?this.die():(this.alpha=.5,this.hitTimer=60,this.speedX-=20))},CANDY.Player.prototype.die=function(){this.visible=!1,CANDY.Controls.stop(),CANDY.showGameOver()},CANDY.Player.prototype.updateTransform=function(){CANDY.Controls.pressed(CANDY.Controls.UP)?this.speedY-=this.ACCELERATION:CANDY.Controls.pressed(CANDY.Controls.DOWN)?this.speedY+=this.ACCELERATION:this.speedY/=1.3,CANDY.Controls.pressed(CANDY.Controls.LEFT)?this.speedX-=this.ACCELERATION:CANDY.Controls.pressed(CANDY.Controls.RIGHT)?this.speedX+=this.ACCELERATION:this.speedX/=1.3,this.hitTimer--,this.hitTimer<=0&&(this.alpha=1),this.speedY=CANDY.Utils.boundary(this.speedY,-this.MAX_SPEED,this.MAX_SPEED),Math.abs(this.speedY)<.3&&(this.speedY=0),this.position.y+=this.speedY,this.speedX=CANDY.Utils.boundary(this.speedX,-this.MAX_SPEED,this.MAX_SPEED),Math.abs(this.speedX)<.3&&(this.speedX=0),this.position.x+=this.speedX,0!=this.speedY||0!=this.speedX?this.play():this.gotoAndStop(0),this.position.y=CANDY.Utils.boundary(this.position.y,this.MIN_Y,this.MAX_Y),this.position.x=CANDY.Utils.boundary(this.position.x,this.MIN_X,this.MAX_X),this.hitArea.x=this.position.x+this.hitOffset.x,this.hitArea.y=this.position.y+this.hitOffset.y,PIXI.MovieClip.prototype.updateTransform.call(this)},CANDY.CollisionManager=function(a,b,c){PIXI.EventTarget.call(this),this.player=a,this.enemiesManager=b,this.bulletsManager=c},CANDY.CollisionManager.constructor=CANDY.CollisionManager,CANDY.CollisionManager.prototype.checkCollision=function(){for(var a=this.enemiesManager.enemies,b=this.bulletsManager.bullets,c=a.length;c--;)if(a[c].active){for(var d=b.length;d--;)b[d].visible&&a[c].hitArea&&!a[c].cantTouch&&a[c].hitArea.contain(b[d].position)&&(a[c].touched(b[d]),b[d].canRealloc(),this.dispatchEvent("ENEMY_TOUCHED"),CANDY.Sounds.play("bullet"));a[c].hitArea&&this.player.visible&&1==this.player.alpha&&a[c].hitArea.intersectWith(this.player.hitArea)&&(a[c].canRealloc(),this.player.hitEnnemy(),CANDY.Sounds.play("aie"),this.dispatchEvent("TOUCH_ENEMY"))}},CANDY.Pool=function(a){this.queue=[],this.objects=a},CANDY.Pool.prototype={add:function(a){return this.objects.push(a),this.call()},call:function(){if(this.objects.length&&this.queue.length){var a=this.queue.shift(),b=this.objects.shift();a(b,this)}return this},act:function(a){return this.queue.push(a),this.call()}},CANDY.SpriteSheetTextures={getArray:function(a,b,c,d){d=d||1;for(var e=[],f=c,g=d;f--;)e.push(PIXI.Texture.fromFrame(a+g+b)),g++;return e}},CANDY.Controls={UP:38,DOWN:40,LEFT:37,RIGHT:39,S:83,keysPressed:[],start:function(){var a=this;this.keyDownHandler=function(b){b.preventDefault(),a.keyDown(b)},document.addEventListener("keydown",this.keyDownHandler),this.keyUpHandler=function(b){b.preventDefault(),a.keyUp(b)},document.addEventListener("keyup",this.keyUpHandler)},stop:function(){document.removeEventListener("keydown",this.keyDownHandler),document.removeEventListener("keyup",this.keyUpHandler),this.keysPressed=[]},keyDown:function(a){this.keysPressed[a.keyCode]=!0},keyUp:function(a){this.keysPressed[a.keyCode]=!1},pressed:function(a){return this.keysPressed[a]}},CANDY.Sounds={url:"sound/",formats:["mp3"],init:function(){this.create("bullet",10),this.create("aie",2),this.create("candyfall",10),this.create("jump",1),this.create("fire",1),this.create("king",1),this.create("apple",1),this.create("smurf",1)},play:function(a){this[a][this[a+"Pointer"]].play(),this[a+"Pointer"]++,this[a+"Pointer"]==this[a].length&&(this[a+"Pointer"]=0)},create:function(a,b){this[a]=[];for(var c=0;b>c;c++)this[a].push(new buzz.sound(this.url+a,{formats:this.formats}));this[a+"Pointer"]=0}},CANDY.Utils={boundary:function(a,b,c){return b>a?b:a>c?c:a},randomBetween:function(a,b,c){var d=Math.random()*(b-a)+a;return c?d:Math.floor(d)}},CANDY.Rectangle=function(a,b,c,d){PIXI.Rectangle.call(this,a,b,c,d)},CANDY.Rectangle.constructor=CANDY.Rectangle,CANDY.Rectangle.prototype=Object.create(PIXI.Rectangle.prototype),CANDY.Rectangle.prototype.contain=function(a){return a.x>=this.x&&a.x<=this.x+this.width&&a.y>=this.y&&a.y<=this.y+this.height?!0:!1},CANDY.Rectangle.prototype.intersectWith=function(a){return(this.x+this.width>a.x&&this.x<a.x+a.width||this.x>a.x&&this.x<a.x+a.width)&&(this.y+this.height>a.y&&this.y<a.y+a.height||this.y>a.y&&this.y<a.y+a.height)?!0:!1},CANDY.BossUI={init:function(){this.el=document.getElementById("boss-ui"),this.bar=document.querySelectorAll("#boss-ui .bar > div")[0],this.name=document.querySelectorAll("#boss-ui .name")[0],this.bubble=document.querySelectorAll("#boss-ui .bubble")[0]},show:function(){this.el.classList.add("show")},hide:function(){this.el.classList.remove("show")},setName:function(a){this.name.innerHTML=a},showBubble:function(a){this.bubble.innerHTML=a,this.bubble.classList.add("show")},hideBubble:function(){this.bubble.classList.remove("show")},majBar:function(a){this.bar.style.width=a+"%"}},CANDY.PlayerUI={init:function(){this.el=document.getElementById("player-ui"),this.bar=document.querySelectorAll("#player-ui .bar > div")[0]},show:function(){this.el.classList.add("show")},hide:function(){this.el.classList.remove("show")},majBar:function(a){this.bar.style.width=a+"%"}},function(){function a(){w=PIXI.Sprite.fromImage("img/background.png"),j.addChild(w),x=new CANDY.Player,z=new CANDY.EnemiesManager(x,h),CANDY.enemiesManager=z,j.addChild(z),j.addChild(x),x.init(),z.init(),y=new CANDY.BulletsManager(x),j.addChild(y),A=new CANDY.CollisionManager(x,z,y),requestAnimFrame(f),CANDY.Controls.start(),x.canShoot=!0,m.classList.add("show"),n.addEventListener("click",b)}function b(){return n.removeEventListener("click",b),m.classList.remove("show"),CANDY.Controls.stop(),x.canShoot=!1,c(),!1}function c(){o.classList.add("show"),p.addEventListener("click",d)}function d(){return p.removeEventListener("click",d),o.classList.remove("show"),setTimeout(function(){e()},1e3),!1}function e(){x.init(),CANDY.Controls.start(),CANDY.PlayerUI.show(),setTimeout(function(){z.initLevel1()},3e3);var a=new Date;k=a.getTime()}function f(){requestAnimFrame(f),l||(v.render(j),A.checkCollision())}function g(){return r.removeEventListener("click",g),e(),q.classList.remove("show"),!1}function h(){var a=new Date,b=a.getTime()-k,c=Math.round(b/1e3),d=Math.floor(c/60);c%=60;var e="";d>0&&(e+=d+" minute",d>1&&(e+="s")),d>0&&c>0&&(e+=" and "),c>0&&(e+=" "+c+" second",c>1&&(e+="s")),t.innerHTML=e,s.classList.add("show"),u.addEventListener("click",i)}function i(){return u.removeEventListener("click",i),e(),s.classList.remove("show"),!1}var j=new PIXI.Stage(0);CANDY.Config={width:1100,height:800};var k,l=!1,m=document.getElementById("home"),n=document.querySelectorAll("#home .play")[0],o=document.getElementById("story"),p=document.querySelectorAll("#story .play")[0],q=document.getElementById("game-over"),r=document.querySelectorAll("#game-over .retry")[0],s=document.getElementById("complete"),t=document.querySelectorAll("#complete .time span")[0],u=document.querySelectorAll("#complete .replay")[0];CANDY.BossUI.init(),CANDY.PlayerUI.init(),CANDY.Sounds.init();var v=PIXI.autoDetectRenderer(CANDY.Config.width,CANDY.Config.height);document.getElementById("game").appendChild(v.view);var w,x,y,z,A=null,B=new PIXI.AssetLoader(["img/candy1.png","img/candy2.png","img/candy3.png","img/candy4.png","img/candy5.png","img/candy6.png","img/king.png","img/player.json","img/background.png","img/papasmurf.json","img/smurf.json","img/apple.png","img/skittle1.png","img/skittle2.png","img/skittle3.png","img/skittle4.png","img/candy-shadow.png","img/bolt.json"]);B.onComplete=a,B.load(),CANDY.showGameOver=function(){l=!0,CANDY.BossUI.hide(),CANDY.PlayerUI.hide(),CANDY.Controls.stop(),q.classList.add("show"),setTimeout(function(){z.removeAll(),l=!1,r.addEventListener("click",g)},2e3)}}();